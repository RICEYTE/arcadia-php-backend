 ...
 */
final class Version20240627224537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX uniq_identifier_email RENAME TO UNIQ_IDENTIFIER_USERNAME');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER INDEX uniq_identifier_username RENAME TO uniq_identifier_email');
    }
}
